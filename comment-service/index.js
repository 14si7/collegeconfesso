...
// This file sets up the Comment Service, a federated GraphQL microservice.
...
async function startServer() {
  ...
  // --- Start Listening ---
  const PORT = process.env.PORT || 4002; // Use a default port if not specified
  app.listen(PORT, () =>
    console.log(`🚀 Comment Service running at http://localhost:${PORT}${server.graphqlPath}`)
  );
}
